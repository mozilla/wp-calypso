...
console.log( config.getMofoSite.toString() );
console.log( config.getPreviewURL.toString() );
...
console.log( 'module.exports.getMofoSite = getMofoSite;' );
console.log( 'module.exports.getPreviewURL = getPreviewURL;' );
